(defproject om-remote "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "om-remote.core/on-js-reload"
                ...
                :compiler {:main om-remote.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/om-remote.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/om-remote.js"
                           :main om-remote.core
