...
var len__30169__auto___50059 = arguments.length;
var i__30170__auto___50060 = (0);
while(true){
if((i__30170__auto___50060 < len__30169__auto___50059)){
args__30176__auto__.push((arguments[i__30170__auto___50060]));

var G__50061 = (i__30170__auto___50060 + (1));
i__30170__auto___50060 = G__50061;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__30177__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq50057){
var G__50058 = cljs.core.first.call(null,seq50057);
var seq50057__$1 = cljs.core.next.call(null,seq50057);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__50058,seq50057__$1);
});
...
return (function (p1__50062_SHARP_){
return (p1__50062_SHARP_ === object);
});})(history))
,history);
});
