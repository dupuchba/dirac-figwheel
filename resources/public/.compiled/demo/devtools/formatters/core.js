...
var and__28936__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__28936__auto__){
var or__28948__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e50481){var e__31537__auto__ = e50481;
return false;
...
}catch (e50483){var e__31537__auto__ = e50483;
return false;
...
}catch (e50489){var e__31537__auto__ = e50489;
return false;
...
}catch (e50491){var e__31537__auto__ = e50491;
return false;
...
}catch (e50497){var e__31537__auto__ = e50497;
return false;
}})())){
...
}catch (e50499){var e__31537__auto__ = e50499;
return false;
}})())){
...
var _STAR_current_state_STAR_50502 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__28948__auto__ = config;
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50502;
}});
});
...
return (function() { 
var G__50505__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e50504){var e = e50504;
...
while (G__50506__i < G__50506__a.length) {G__50506__a[G__50506__i] = arguments[G__50506__i + 0]; ++G__50506__i;}
  args = new cljs.core.IndexedSeq(G__50506__a,0);
} 
return G__50505__delegate.call(this,args);};
G__50505.cljs$lang$maxFixedArity = 0;
G__50505.cljs$lang$applyTo = (function (arglist__50507){
var args = cljs.core.seq(arglist__50507);
return G__50505__delegate(args);
});
...
var pre_handler = (function (){var or__28948__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
...
var post_handler = (function (){var or__28948__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
return cljs.core.identity;
