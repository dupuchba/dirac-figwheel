...
var G__50025 = devtools.prefs.pref.call(null,v);
v = G__50025;
continue;
} else {
return v;
...
var and__28936__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28936__auto__){
var and__28936__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28948__auto__ = (function (){try{if(!((value == null))){
...
}catch (e50038){var e__31537__auto__ = e50038;
return false;
}})();
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
var or__28948__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e50042){var e__31537__auto__ = e50042;
return false;
}})();
...
}catch (e50044){var e__31537__auto__ = e50044;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__28936__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28936__auto__)){
var and__28936__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28936__auto____$1){
...
var and__28936__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__28936__auto__)){
...
var or__28948__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
...
var and__28936__auto__ = (function (){var or__28948__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
...
var vec__50049 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__50049,(0),null);
var name = cljs.core.nth.call(null,vec__50049,(1),null);
...
var and__28936__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28936__auto__)){
...
var or__28948__auto__ = typeof value === 'string';
if(or__28948__auto__){
return or__28948__auto__;
} else {
var or__28948__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__50052_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50052_SHARP_);
}),template);
});
