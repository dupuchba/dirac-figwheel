...
var len__30169__auto___50068 = arguments.length;
var i__30170__auto___50069 = (0);
while(true){
if((i__30170__auto___50069 < len__30169__auto___50068)){
args__30176__auto__.push((arguments[i__30170__auto___50069]));

var G__50070 = (i__30170__auto___50069 + (1));
i__30170__auto___50069 = G__50070;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__30177__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50065){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50066,G__50067,seq50065__$2);
});
...
if(cljs.core.truth_((function (){var or__28948__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__29605__auto__,writer__29606__auto__,opt__29607__auto__){
return cljs.core._write.call(null,writer__29606__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__28936__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__28936__auto__){
var or__28948__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50071_SHARP_){
return !((cljs.core.meta.call(null,p1__50071_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__50080__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__28948__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50084){var e__31537__auto__ = e50084;
return false;
}})();
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
...
}catch (e50086){var e__31537__auto__ = e50086;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50091 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50092 = opts;
...
var markup_db = cljs.core.get.call(null,map__50092__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50091;
}});
...
;
var temp__6751__auto___50097 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___50097)){
var managed_print_level_50098 = temp__6751__auto___50097;
var _STAR_print_level_STAR_50096_50099 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50098;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50096_50099,managed_print_level_50098,temp__6751__auto___50097,writer,opts,job_fn){
return (function (p1__50094_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50094_SHARP_,null);
});})(_STAR_print_level_STAR_50096_50099,managed_print_level_50098,temp__6751__auto___50097,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50096_50099;
}} else {
job_fn.call(null);
}
