...
var reader = (function (){var or__28948__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__28948__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__28948__auto__)){
return or__28948__auto__;
} else {
return (128);
...
}catch (e51249){var _e = e51249;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___51252 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___51252)){
var seen_errors_51253 = temp__6751__auto___51252;
if(cljs.core.truth_(seen_errors_51253.has(self))){
} else {
seen_errors_51253.add(self);

var temp__6753__auto___51254 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___51254)){
var sense_51255 = temp__6753__auto___51254;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_51255)].join('');
} else {
}
}
} else {
