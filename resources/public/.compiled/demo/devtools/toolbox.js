...
var args50962 = [];
var len__30169__auto___50968 = arguments.length;
var i__30170__auto___50969 = (0);
while(true){
if((i__30170__auto___50969 < len__30169__auto___50968)){
args50962.push((arguments[i__30170__auto___50969]));

var G__50970 = (i__30170__auto___50969 + (1));
i__30170__auto___50969 = G__50970;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox50965 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox50965 = (function (obj,header,style,tag,meta50966){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox50965.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50967,meta50966__$1){
var self__ = this;
var _50967__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox50965(self__.obj,self__.header,self__.style,self__.tag,meta50966__$1));
});


devtools.toolbox.t_devtools$toolbox50965.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50967){
var self__ = this;
var _50967__$1 = this;
...
devtools.toolbox.t_devtools$toolbox50965.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;


devtools.toolbox.t_devtools$toolbox50965.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox50965.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});
...
devtools.toolbox.t_devtools$toolbox50965.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox50965.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta50966","meta50966",-98755744,null)], null);
});

devtools.toolbox.t_devtools$toolbox50965.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox50965.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox50965";

devtools.toolbox.t_devtools$toolbox50965.cljs$lang$ctorPrWriter = (function (this__29605__auto__,writer__29606__auto__,opt__29607__auto__){
return cljs.core._write.call(null,writer__29606__auto__,"devtools.toolbox/t_devtools$toolbox50965");
});

devtools.toolbox.__GT_t_devtools$toolbox50965 = (function devtools$toolbox$__GT_t_devtools$toolbox50965(obj__$1,header__$1,style__$1,tag__$1,meta50966){
return (new devtools.toolbox.t_devtools$toolbox50965(obj__$1,header__$1,style__$1,tag__$1,meta50966));
});

}

return (new devtools.toolbox.t_devtools$toolbox50965(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
