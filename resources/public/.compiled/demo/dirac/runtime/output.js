...
return clojure.string.join.call(null,cljs.core.map.call(null,(function (p1__50739_SHARP_){
if(cljs.core.truth_(dirac.runtime.output.style_QMARK_.call(null,p1__50739_SHARP_))){
return "%c";
} else {
return "%s";
}
